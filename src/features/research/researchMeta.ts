export const RESEARCH_META: Record<string, { name: string; description: string; category: string }> = {
  ...
  horsemanship:     { category: 'Logística',     name: 'Equitación',        description: 'Caballos más veloces: Escuderos, Exploradores y Caravanas ganan +10% velocidad/nivel.' },
  cartography:      { category: 'Logística',     name: 'Cartografía',       description: 'Rutas óptimas: Caballeros, Paladines, Colonistas y Maestros de Asedio ganan +20%/nivel.' },
  tradeRoutes:      { category: 'Logística',     name: 'Rutas Comerciales', description: 'Arte de vanguardia: Señores, Grandes Caballeros, Máquinas de Guerra y Dragones +30%/nivel.' },
