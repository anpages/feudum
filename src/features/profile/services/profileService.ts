...
export const profileService = {
  ...
  renameKingdom:   (name: string, id?: string) => http.patch<{ ok: boolean; name: string }>('/kingdoms/me', { name, id }),
  abandonKingdom:  (id: string) => http.delete<{ ok: boolean }>(`/kingdoms/me?id=${id}`),
}
