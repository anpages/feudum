 ...
 * checkAndUnlock(userId) — queries DB, unlocks any newly earned achievements,
...
function checkConditions(data) {
  ...
  check('season_champion', bossKilled) // simplified: boss kill = season win
...
export async function checkAndUnlock(userId) {
  ...
  // Pick main kingdom (first non-colony or just first)
