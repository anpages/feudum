...
export const battleLog = pgTable('battle_log', {
  ...
  attackerForce:     jsonb('attacker_force').default({}).notNull(),
  attackerLost:      jsonb('attacker_lost').default({}).notNull(),
  ...
  defenderForce:     jsonb('defender_force').default({}).notNull(),
  defenderLost:      jsonb('defender_lost').default({}).notNull(),
  missionType:       varchar('mission_type', { length: 20 }).notNull(),
